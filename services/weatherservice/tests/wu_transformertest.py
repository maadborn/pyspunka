...
class WUTransformerTest(unittest.TestCase):
    def wu_transform(self):
        t = WUTransformer()
        location_id = '01234567abcdef'
        transformed = t.transform_data(testdata_wu_in. location_id)
        self.assertDictEqual(transformed, testdata_wu_expected, "Transformed structure is not the same as expected")
